...
then
    ...
    git diff --quiet timezones-include-fraction.json || git add timezones-include-fraction.json
fi
...
then
    ...
    git diff --quiet latitudes.json || git add latitudes.json
fi
